            ...
            <Form @submit="onSubmit" v-slot="{ errors }">
              <div class="form-group form-select-search" v-if="event_detail.setting.guest_title_toggle == 'Y'">
                <div class="form-control-select" :class="{ errorfield: errors.salutation }">
                  <Field as="select" name="salutation" id="salutation" class="form-control" v-model="form_Reg.salutation" :rules="isRequired">
              ...
              <div class="form-group">
                <Field type="text" class="form-control" name="fullname" v-model="form_Reg.fullname" placeholder="Full Name / Nama Lengkap" :rules="isRequired" :class="{ errorfield: errors.fullname }"> </Field>
                <span class="icon-form"><i class="bx bxs-user"></i></span>
                <ErrorMessage class="notif-verror" name="fullname" />
              </div>
              <div class="row">
                <div class="col-md-6" v-if="event_detail.setting.yob_toggle == 'Y'">
                  <div class="form-group form-select-search">
                    <div class="form-control-select" :class="{ errorfield: errors.yob }" v-if="event_detail.setting.yob_required === 'Y'">
                      <Field as="select" name="yob" id="yob" class="form-control" v-model="form_Reg.yob" :rules="isRequired">
                        <option v-for="year in years_list" v-bind:value="year">
                          {{ year }}
                        </option>
                      </Field>
                    </div>
                    <Field as="select" name="yob" id="yob" class="form-control" v-model="form_Reg.yob" v-else>
                      <option v-for="year in years_list" v-bind:value="year">
                        {{ year }}
                      </option>
                    </Field>
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    <div class="filter-country">
                      <Field as="select" id="select_country" name="region" style="width: 100%" v-model="form_Reg.country_code">
                        <option value="">Select a Country</option>
                        <option v-for="code in code_country" :data-image="code.flags" v-bind:value="code.phonecode">+{{ code.phonecode }} &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{{ code.country_name }}</option>
                      </Field>
                      <Field
                        type="number"
                        class="form-control padding-100"
                        name="phone_number"
                        :class="{ errorfield: errors.phone_number }"
                        v-model="phone_number"
                        @input="check_phonenumber(phone_number)"
                        maxlength="14"
                        oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');"
                        placeholder="Phone Number / No. WhatsApp"
                        :rules="isRequired"
                      ></Field>
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <div class="notif-verror" v-if="notif_email">invalid email address / email tidak valid (format: xxx@xxx.xxx)</div>
                  </div>
                </div>
                <!-- <div class="col-md-6">
                                    <div class="form-group">
                ...
                <div class="col-md-6" v-if="event_detail.setting.birth_date_toggle == 'Y'">
                  <div class="form-group">
                    <Field type="text" class="form-control" name="birth_date" id="birth_date" v-model="form_Reg.birth_date" placeholder="Birthdate / Tanggal lahir (dd/mm/yyyy)" :rules="isRequired" :class="{ errorfield: errors.birth_date }">
                    </Field>
                    <span class="icon-form"><i class="bx bxs-user"></i></span>
                ...
                <div class="col-md-6" v-if="event_detail.setting.sex_toggle == 'Y'">
                  <div class="form-group form-select-search">
                    <div class="form-control-select" :class="{ errorfield: errors.sex }">
                      <Field as="select" name="sex" id="sex" class="form-control" v-model="form_Reg.sex" :rules="isRequired">
                ...
                <div class="col-md-6" v-if="event_detail.setting.profession_toggle == 'Y'">
                  <div class="form-group form-select-search">
                    <div class="form-control-select" :class="{ errorfield: errors.profession }" v-if="event_detail.setting.profession_required == 'Y'">
                      <Field as="select" name="profession" id="profession" class="form-control" v-model="form_Reg.profession" :rules="isRequired">
                        <option v-for="profession in profession_enable" v-bind:value="profession.profession_id">
                          {{ profession.profession_name }}
                        </option>
                      </Field>
                    </div>
                    <Field as="select" name="profession" id="profession" class="form-control" v-model="form_Reg.profession" v-else>
                      <option v-for="profession in profession_enable" v-bind:value="profession.profession_id">
                        {{ profession.profession_name }}
                      </option>
                    </Field>
                ...
                <div class="col-md-6" v-if="form_Reg.profession_isothers == 'Y'">
                  <div class="form-group">
                    <Field
                      ...
                      placeholder="Profession Others / Profesi Lainnya"
                      :rules="isRequired"
                ...
                <div class="col-md-6" v-if="event_detail.setting.jobtitle_toggle == 'Y'">
                  <div class="form-group form-select-search">
                    <div class="form-control-select" :class="{ errorfield: errors.position }" v-if="event_detail.setting.jobtitle_required == 'Y'">
                      <Field as="select" name="position" id="position" class="form-control" v-model="form_Reg.position" :rules="isRequired">
                        <option v-for="position in data_position_enable" v-bind:value="position.position_id">
                          {{ position.position_name }}
                        </option>
                      </Field>
                    </div>
                    <Field as="select" name="position" id="position" class="form-control" v-model="form_Reg.position" v-else>
                      <option v-for="position in data_position_enable" v-bind:value="position.position_id">
                        {{ position.position_name }}
                      </option>
                    </Field>
                ...
                <div class="col-md-6" v-if="form_Reg.position_isothers == 'Y'">
                  <div class="form-group">
                    <Field type="text" class="form-control" name="position_others" v-model="form_Reg.position_others" placeholder="Position Others / Posisi Lainnya" :rules="isRequired" :class="{ errorfield: errors.position_others }" />
                    <span class="icon-form"><i class="bx bxs-briefcase"></i></span>
                ...
                <div class="col-md-6" v-if="event_detail.setting.division_toggle == 'Y'">
                  <div class="form-group form-select-search">
                    <div class="form-control-select" :class="{ errorfield: errors.division }" v-if="event_detail.setting.division_required == 'Y'">
                      <Field as="select" name="division" id="division" class="form-control" v-model="form_Reg.division" :rules="isRequired">
                        <option v-for="division in data_division_enable" v-bind:value="division.division_id">
                          {{ division.division_name }}
                        </option>
                      </Field>
                    </div>
                    <Field as="select" name="division" id="division" class="form-control" v-model="form_Reg.division" v-else>
                      <option v-for="division in data_division_enable" v-bind:value="division.division_id">
                        {{ division.division_name }}
                      </option>
                    </Field>
                ...
                <div class="col-md-6" v-if="form_Reg.division_isothers == 'Y'">
                  <div class="form-group">
                    <Field type="text" class="form-control" name="division_others" v-model="form_Reg.division_others" placeholder="division Others / Divisi Lainnya" :rules="isRequired" :class="{ errorfield: errors.division_others }" />
                    <span class="icon-form"><i class="bx bxs-briefcase"></i></span>
                ...
                <div class="col-md-6" v-if="event_detail.setting.nim_toggle == 'Y'">
                  <div class="form-group">
                    <Field type="text" class="form-control" id="nim" name="nim" v-model="form_Reg.nim" placeholder="NIM" :rules="isRequired" :class="{ errorfield: errors.nim }" v-if="event_detail.setting.nim_required == 'Y'" />
                    <Field type="text" class="form-control" id="nim" name="nim" v-model="form_Reg.nim" placeholder="NIM (Optional)" v-else />
                ...
                <div class="col-md-6" v-if="event_detail.setting.faculty_toggle == 'Y'">
                  <div class="form-group">
                    <Field
                      ...
                      placeholder="Faculty Name / Nama Fakultas"
                      :rules="isRequired"
                      :class="{ errorfield: errors.faculty_name }"
                      v-if="event_detail.setting.faculty_required == 'Y'"
                    />
                    <Field type="text" class="form-control" id="faculty_name" name="faculty_name" v-model="form_Reg.faculty_name" placeholder="Faculty Name / Nama Fakultas (Optional)" v-else />
                    <span class="icon-form"><i class="bx bxs-bank"></i></span>
                ...
                <div class="col-md-6" v-if="event_detail.setting.companyname_toggle == 'Y'">
                  <div class="form-group">
                    ...
                    />
                    <Field type="text" class="form-control" id="company" name="company" v-model="form_Reg.company" placeholder="Company (Optional)" v-else />
                    <span class="icon-form"><i class="bx bxs-bank"></i></span>
                ...
                <div class="col-md-6" v-if="event_detail.setting.companytype_toggle == 'Y'">
                  <div class="form-group form-select-search">
                    <div class="form-control-select" :class="{ errorfield: errors.company_type }" v-if="event_detail.setting.companytype_required == 'Y'">
                      <Field as="select" name="company_type" id="company_type" class="form-control" v-model="form_Reg.company_type" :rules="isRequired">
                        <option v-for="companytype in data_companytype_enable" v-bind:value="companytype.comptype_id">
                          {{ companytype.comptype_name }}
                        </option>
                      </Field>
                    </div>
                    <Field as="select" name="company_type" id="company_type" class="form-control" v-model="form_Reg.company_type" v-else>
                      <option v-for="companytype in data_companytype_enable" v-bind:value="companytype.comptype_id">
                        {{ companytype.comptype_name }}
                      </option>
                    </Field>
                ...
                <div class="col-md-6" v-if="form_Reg.company_type_isothers == 'Y'">
                  <div class="form-group">
                    <Field type="text" class="form-control" name="company_type_others" v-model="form_Reg.company_type_others" placeholder="Company Type Others" :rules="isRequired" :class="{ errorfield: errors.company_type_others }" />
                    <span class="icon-form"><i class="bx bxs-briefcase"></i></span>
                ...
                <div class="col-md-6" v-if="event_detail.setting.companycountry_toggle == 'Y'">
                  <div class="form-group form-select-search">
                    <div class="form-control-select" :class="{ errorfield: errors.company_country }" v-if="event_detail.setting.companycountry_required == 'Y'">
                      <Field as="select" name="company_country" id="company_country" class="form-control" v-model="form_Reg.company_country" :rules="isRequired">
                        <option v-for="code in code_country" v-bind:value="code.country_code">
                          {{ code.country_name }}
                        </option>
                      </Field>
                    </div>
                    <Field as="select" name="company_country" id="company_country" class="form-control" v-model="form_Reg.company_country" v-else>
                      <option v-for="code in code_country" v-bind:value="code.country_code">
                        {{ code.country_name }}
                      </option>
                    </Field>
                ...
                <div class="col-md-6" v-if="event_detail.setting.companycity_toggle == 'Y'">
                  <div class="form-group form-select-search">
                    <div class="form-control-select" :class="{ errorfield: errors.company_province }" v-if="event_detail.setting.companycity_required == 'Y'">
                      <Field as="select" name="company_province" id="company_province" class="form-control" v-model="form_Reg.company_province" :rules="isRequired">
                        <option v-for="data_province in data_province" v-bind:value="data_province.province_code">
                          {{ data_province.province_name }}
                        </option>
                      </Field>
                    </div>
                    <Field as="select" name="company_province" id="company_province" class="form-control" v-model="form_Reg.company_province" v-else>
                      <option v-for="data_province in data_province" v-bind:value="data_province.province_code">
                        {{ data_province.province_name }}
                      </option>
                    </Field>
                ...
                <div class="col-md-6" v-if="event_detail.setting.companycity_toggle == 'Y'">
                  <div class="form-group form-select-search">
                    <div class="form-control-select" :class="{ errorfield: errors.company_city }" v-if="event_detail.setting.companycity_required == 'Y'">
                      <Field as="select" name="company_city" id="company_city" class="form-control" v-model="form_Reg.company_city" :rules="isRequired">
                        <option v-for="data_city in data_city" v-bind:value="data_city.city_code">
                          {{ data_city.city_name }}
                        </option>
                      </Field>
                    </div>
                    <Field as="select" name="company_city" id="company_city" class="form-control" v-model="form_Reg.company_city" v-else>
                      <option v-for="data_city in data_city" v-bind:value="data_city.city_code">
                        {{ data_city.city_name }}
                      </option>
                    </Field>
                ...
                <div class="col-md-6" v-if="event_detail.setting.reguler_invitationcode_toggle == 'Y'">
                  <div class="form-group">
                    <Field
                      type="text"
                      class="form-control"
                      id="regular_invitation_code"
                      name="regular_invitation_code"
                      v-model="form_Reg.invitationcode"
                      placeholder="Invitation Code / Kode Undangan"
                      :rules="isRequired"
...
export default {
  ...
  methods: {
    ...
    check_phonenumber(input_phone) {
      ...
      if (phone.toString().startsWith("0")) this.phone_number = phone.toString().substring(1);
    },
    get_codecountry() {
      this.isLoadingAnimation = true;
      axios({
        ...
        setTimeout(function () {
          ...
          function formatState(opt) {
            ...
            if (!optimage) {
              ...
              var $opt = $('<span><img src="' + is.global_url + optimage + '" width="25px" />' + opt.text.toUpperCase() + "</span>");
              return $opt;
            }
          }
        }, 50);
      ...
      axios({
        ...
        if (res.data.status == 200) {
          ...
          if (this.event_detail.setting.rsvp_assesment == "Y") {
            ...
            this.$router.push("/checkoutpage/" + this.form_Reg.events_id);
          }
        } else {
          this.isLoadingAnimation = false;
          Swal.fire({
