            ...
            <Form @submit="onSubmit" v-slot="{ errors }">
              ...
              <div class="row">
                  ...
                  <div class="form-group">
                    <div class="filter-country">
                      <Field as="select" id="select_country" name="region" style="width: 100%"
                        ...
                        <option v-for="code in code_country" :data-image="code.flags" v-bind:value="code.phonecode">
                          +{{ code.phonecode }} &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{{ code.country_name }}
                        </option>
                      </Field>
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    <Field type="text" class="form-control" name="email_address" id="email_address"
                      ...
                      v-on:keyup="ValidateEmail(form_Reg.email)" :class="{ errorfield: errors.email_address }" />
                    <span class="icon-form"><i class="bx bxs-envelope"></i></span>
                    <ErrorMessage class="notif-verror" name="email_address" />
                    <div class="notif-verror" v-if="notif_email">invalid email address / email tidak valid (format:
                      xxx@xxx.xxx)</div>
                  </div>
                </div>
                <!-- <div class="col-md-6">
                ...
                <div class="col-md-6" v-if="form_Reg.profession_isothers == 'Y'">
                  <div class="form-group">
                    <Field type="text" class="form-control" name="profession_others"
                      v-model="form_Reg.profession_others" placeholder="Profession Others / Profesi Lainnya"
                      :rules="isRequired" :class="{ errorfield: errors.profession_others }" />
                    <span class="icon-form"><i class="bx bxs-briefcase"></i></span>
                ...
                <div class="col-md-6" v-if="event_detail.setting.jobtitle_toggle == 'Y'">
                  <div class="form-group form-select-search">
                    <div class="form-control-select" :class="{ errorfield: errors.position }"
                      ...
                      <Field as="select" name="position" id="position" class="form-control" v-model="form_Reg.position"
                        :rules="isRequired">
                ...
                <div class="col-md-6" v-if="form_Reg.position_isothers == 'Y'">
                  <div class="form-group">
                    <Field type="text" class="form-control" name="position_others" v-model="form_Reg.position_others"
                ...
                <div class="col-md-6" v-if="event_detail.setting.division_toggle == 'Y'">
                  <div class="form-group form-select-search">
                    <div class="form-control-select" :class="{ errorfield: errors.division }"
                      ...
                      <Field as="select" name="division" id="division" class="form-control" v-model="form_Reg.division"
                        :rules="isRequired">
                ...
                <div class="col-md-6" v-if="form_Reg.division_isothers == 'Y'">
                  <div class="form-group">
                    <Field type="text" class="form-control" name="division_others" v-model="form_Reg.division_others"
                ...
                <div class="col-md-6" v-if="event_detail.setting.nim_toggle == 'Y'">
                  <div class="form-group">
                    <Field type="text" class="form-control" id="nim" name="nim" v-model="form_Reg.nim" placeholder="NIM"
                      :rules="isRequired" :class="{ errorfield: errors.nim }"
                ...
                <div class="col-md-6" v-if="event_detail.setting.faculty_toggle == 'Y'">
                  <div class="form-group">
                    <Field type="text" class="form-control" id="faculty_name" name="faculty_name"
                      v-model="form_Reg.faculty_name" placeholder="Faculty Name / Nama Fakultas" :rules="isRequired"
                      :class="{ errorfield: errors.faculty_name }"
                      v-if="event_detail.setting.faculty_required == 'Y'" />
                    <Field type="text" class="form-control" id="faculty_name" name="faculty_name"
                      v-model="form_Reg.faculty_name" placeholder="Faculty Name / Nama Fakultas (Optional)" v-else />
                    <span class="icon-form"><i class="bx bxs-bank"></i></span>
                ...
                <div class="col-md-6" v-if="event_detail.setting.companyname_toggle == 'Y'">
                  <div class="form-group">
                    <Field type="text" class="form-control" id="company" name="company" v-model="form_Reg.company"
                      placeholder="Company (Optional)" :rules="isRequired" :class="{ errorfield: errors.company }"
                      v-if="event_detail.setting.companyname_required == 'Y'" />
                    <Field type="text" class="form-control" id="company" name="company" v-model="form_Reg.company"
                      placeholder="Company (Optional)" v-else />
                    <span class="icon-form"><i class="bx bxs-bank"></i></span>
                ...
                <div class="col-md-6" v-if="form_Reg.company_type_isothers == 'Y'">
                  <div class="form-group">
                    <Field type="text" class="form-control" name="company_type_others"
                      v-model="form_Reg.company_type_others" placeholder="Company Type Others" :rules="isRequired"
                      :class="{ errorfield: errors.company_type_others }" />
                    <span class="icon-form"><i class="bx bxs-briefcase"></i></span>
                  ...
                  <div class="form-group form-select-search">
                    <div class="form-control-select" :class="{ errorfield: errors.company_province }"
                      ...
                      <Field as="select" name="company_province" id="company_province" class="form-control"
                        v-model="form_Reg.company_province" :rules="isRequired">
                ...
                <div class="col-md-6" v-if="event_detail.setting.reguler_invitationcode_toggle == 'Y'">
                  <div class="form-group">
                    <Field type="text" class="form-control" id="regular_invitation_code" name="regular_invitation_code"
                      v-model="form_Reg.invitationcode" placeholder="Invitation Code / Kode Undangan"
                      :rules="isRequired" :class="{ errorfield: errors.regular_invitation_code }" />
          ...
          setTimeout(function () {
            ...
            function formatState(opt) {
              ...
              if (!optimage) {
                ...
                var $opt = $('<span><img src="' + is.global_url + optimage + '" width="25px" />' + opt.text
                  .toUpperCase() + "</span>");
                return $opt;
              }
            }
