    ...
    <section class="vh-100 container-fluid">
        <div class="row">
            <div class="col-md-8 p-5 vh-100">
                <div class="justify-content-between flex border-bottom" name="cart">
                    <div class="my-car">
                ...
                <div class="row">
                    <h4 class="text-start">Term & Condition</h4>
            ...
            <div class="col-md-4 bg-grey p-5 vh-100">
                <h2 class="mt-3 text-start border-bottom">Your Order Details</h2>
                <div class="justify-content-between flex mt-5">
